...
//==============================================================================
int SectionComp::counters = 0;

SectionComp::SectionComp(NewProjectAudioProcessor& p,int counter):
                             audioProcessor(p),
                             _Wave(p,counter),
                             ...
                             (audioProcessor.getValueTree(), String("ATTACK"+String(counters)), *AttackSlider)),
                             DecayAttachment(new AudioProcessorValueTreeState::SliderAttachment
                             (audioProcessor.getValueTree(), String("DECAY"+String(counters)), *DecaySlider)),
                             SustainAttachment(new AudioProcessorValueTreeState::SliderAttachment
                             (audioProcessor.getValueTree(), String("SUSTAIN"+String(counters)), *SustainSlider)),
                             ReleaseAttachment(new AudioProcessorValueTreeState::SliderAttachment
                             (audioProcessor.getValueTree(), String("RELEASE"+String(counters)), *ReleaseSlider)),
                             FilterTypeAttachment(new AudioProcessorValueTreeState::ComboBoxAttachment
                             (audioProcessor.getValueTree(), String("FILTERCHOICE"+String(counters)), *ChooseFilter)),
                             CutOffAttachment(new AudioProcessorValueTreeState::SliderAttachment
                             (audioProcessor.getValueTree(), String("CUTOFF"+String(counters)), *CutOffSlider)),
                             ResAttachment(new AudioProcessorValueTreeState::SliderAttachment
                             (audioProcessor.getValueTree(), String("RESONANCE"+String(counters)), *ResSlider))
...
//    AttackSlider = std::make_unique<Slider>("ATTACK");
//    DecaySlider = std::make_unique<Slider>("DECAY");
//    SustainSlider = std::make_unique<Slider>("SUSTAIN");
//    ReleaseSlider = std::make_unique<Slider>("RELEASE");
